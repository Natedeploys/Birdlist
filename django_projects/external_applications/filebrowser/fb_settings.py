...
URL_FILEBROWSER_MEDIA = getattr(settings, "FILEBROWSER_URL_FILEBROWSER_MEDIA", settings.MEDIA_URL + "filebrowser/")
...
URL_TINYMCE = getattr(settings, "FILEBROWSER_URL_TINYMCE", settings.MEDIA_URL + "tinymce/jscripts/tiny_mce/")
